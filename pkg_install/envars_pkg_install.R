# check RStudio menu option "Code - Soft Wrap Long Lines"

# READ THE INSTRUCTIONS below!

# install recent versions of R and RStudio, open RStudio, then run the commands below, one at a time, to install the required packages
